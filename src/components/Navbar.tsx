...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <nav className="sticky top-0 z-40 bg-white/90 dark:bg-slate-950/90 backdrop-blur-md border-b border-slate-200/80 dark:border-indigo-900/40 transition-colors">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden lg:flex items-center space-x-1 font-medium text-sm">
            ...
            {/* <button
              ...
              className={`flex items-center space-x-1.5 px-3 py-2 rounded-lg transition-colors ${
                activeTab === 'docs' 
                  ? 'bg-indigo-50 text-indigo-600 dark:bg-indigo-950 dark:text-indigo-400 font-semibold border border-indigo-200 dark:border-indigo-800' 
                  : 'text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-900'
              }`}
            >
