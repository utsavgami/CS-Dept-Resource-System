      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 sm:p-8 border border-slate-200 dark:border-slate-800 shadow-xl space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-start justify-between gap-6">
          ...
          <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6 text-center sm:text-left">
            <Avatar
              ...
              ringClassName={isAdmin ? 'border-purple-500/30' : 'border-blue-500/20'}
            />
            ...
            <div className="space-y-1">
              <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2">
                ...
                {isAdmin ? (
                  <span className="bg-purple-100 text-purple-800 dark:bg-purple-950 dark:text-purple-300 text-[10px] font-extrabold px-2.5 py-0.5 rounded-full flex items-center space-x-1">
        ...
        {isAdmin ? (
          <div className="pt-4 border-t border-slate-100 dark:border-slate-800">
            <div className="p-4 rounded-2xl border border-purple-200 dark:border-purple-900 bg-purple-50/60 dark:bg-purple-950/20 flex items-center gap-3">
              <ShieldAlert className="w-6 h-6 text-purple-600 dark:text-purple-400 shrink-0" />
              <div>
                <p className="text-xs font-bold text-purple-800 dark:text-purple-300">Administrator access</p>
                <p className="text-[11px] text-purple-600/80 dark:text-purple-400/80 mt-0.5">
                  Student stats (rating, listings, complaints) don't apply to this account — manage the platform from the Admin Panel.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="pt-4 border-t border-slate-100 dark:border-slate-800 space-y-3">
          ...
          {isAdmin ? (
            <button
              ...
              className="w-full p-4 rounded-2xl border border-purple-200 dark:border-purple-900 hover:border-purple-400 dark:hover:border-purple-700 hover:bg-purple-50/50 dark:hover:bg-purple-950/20 transition flex items-center justify-center gap-2 focus-visible:outline focus-visible:outline-2 focus-visible:outline-purple-500"
            >
              <ShieldAlert className="w-5 h-5 text-purple-600 dark:text-purple-400" />
              <span className="text-xs font-bold text-slate-700 dark:text-slate-300">Open Admin Control Panel</span>
            </button>
          ) : (
